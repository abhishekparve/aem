...
public final class CCUV3Constants {
	 ...
	 public static final String ARL_INVALIDATE_CPCODE_PROD_PURGING = "/ccu/v3/invalidate/cpcode/production";
	 ...
	 public static final String ARL_REMOVE_CPCODE_PROD_PURGING = "/ccu/v3/delete/cpcode/production";

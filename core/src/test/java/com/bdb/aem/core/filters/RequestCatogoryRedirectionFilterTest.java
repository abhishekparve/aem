...
public class RequestCatogoryRedirectionFilterTest {
	private RequestCatogoryRedirectionFilter fixture = new RequestCatogoryRedirectionFilter();

	private TestLogger logger = TestLoggerFactory.getTestLogger(fixture.getClass());
	@InjectMocks
	RequestCatogoryRedirectionFilter requestCatogoryRedirectionFilter;
	@Mock
	...
	public void testDoFilter() throws IOException, ServletException, LoginException {
		...
		lenient().when(resource.getPath()).thenReturn("/c/content");
		requestCatogoryRedirectionFilter.doFilter(request, response, filterChain);
	}
	...
	public void testDoFiltergeoLoctionCookie() throws IOException, ServletException, LoginException {
		...
		lenient().when(geoLoctionCookie.getValue()).thenReturn("COOKIEVALUE");
		lenient().when(resource.getPath()).thenReturn("/c/content");
		requestCatogoryRedirectionFilter.doFilter(request, response, filterChain);
	}

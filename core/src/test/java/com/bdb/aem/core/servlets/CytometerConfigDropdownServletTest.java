...
public class CytometerConfigDropdownServletTest {

	/** Servlet sso login. */
	@InjectMocks
	CytometerConfigDropdownServlet cytometerConfigDropdownServlet;
	...
	public void testDoGet() throws IOException, LoginException {
		...
		lenient().when(request.getRequestPathInfo()).thenReturn(requestPathInfo);
		cytometerConfigDropdownServlet.doGet(request, response);
	}

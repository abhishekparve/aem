...
public class SvgDataDynamicDropDownServletTest {
	
	/** Servlet sso login. */
	@InjectMocks
	SvgDataDynamicDropDownServlet svgDataDynamicDropDownServlet;
	...
	public void testDoGet() throws IOException, LoginException {
		...
		svgDataDynamicDropDownServlet.doGet(request, response);
	}
